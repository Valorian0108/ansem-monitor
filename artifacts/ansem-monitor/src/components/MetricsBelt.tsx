...
export function MetricsBelt({ data }: MetricsBeltProps) {
  ...
  if (buyRatio > 60) ratioColor = '#39FF14'; // neon green
  else if (buyRatio < 40) ratioColor = '#FF2020'; // red

  return (
    <div className="absolute top-[45%] left-0 right-[280px] flex items-center bg-[#030505] border-y border-[#1a2a1a] px-8 h-12 z-20 overflow-x-auto no-scrollbar">
